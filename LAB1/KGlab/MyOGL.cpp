...
class Camera {
  ...
  public:
    ...
    double distance() { return camDist; }

    int nZ() const { return camNz; }
    double x() const { return camX; }
    double y() const { return camY; }
    double z() const { return camZ; }
    ...
    while (bMsg) {
        ...
        while (!msg_deque.empty()) {
            ...
            case WM_MOUSEMOVE:
                ...
                break;
            case WM_SIZE:
                gl.try_to_resize((short)LOWORD(m.lParam),
                                 (short)HIWORD(m.lParam));
                break;
            case WM_LBUTTONDOWN:
...
void OpenGL::mouseMovie(short mX, short mY) {
    ...
    std::lock_guard<std::mutex> lock(events_mutex);
    events_for_render.push_back(
        [this, arg]() { MouseMovieEvent.exec(this, arg); });
}
...
void OpenGL::mouseLeave(short mX, short mY) {
    ...
    std::lock_guard<std::mutex> lock(events_mutex);
    events_for_render.push_back(
        [this, arg]() { MouseLeaveEvent.exec(this, arg); });
}
...
void OpenGL::mouseLdown(short mX, short mY) {
    ...
    std::lock_guard<std::mutex> lock(events_mutex);
    events_for_render.push_back(
        [this, arg]() { MouseLdownEvent.exec(this, arg); });
}
...
void OpenGL::mouseLup(short mX, short mY) {
    ...
    std::lock_guard<std::mutex> lock(events_mutex);
    events_for_render.push_back(
        [this, arg]() { MouseLupEvent.exec(this, arg); });
}
...
void OpenGL::mouseRdown(short mX, short mY) {
    ...
    std::lock_guard<std::mutex> lock(events_mutex);
    events_for_render.push_back(
        [this, arg]() { MouseRdownEvent.exec(this, arg); });
}
...
void OpenGL::mouseRup(short mX, short mY) {
    ...
    std::lock_guard<std::mutex> lock(events_mutex);
    events_for_render.push_back(
        [this, arg]() { MouseRupEvent.exec(this, arg); });
}
...
void OpenGL::mouseMdown(short mX, short mY) {
    ...
    std::lock_guard<std::mutex> lock(events_mutex);
    events_for_render.push_back(
        [this, arg]() { MouseMdownEvent.exec(this, arg); });
}
...
void OpenGL::mouseMup(short mX, short mY) {
    ...
    std::lock_guard<std::mutex> lock(events_mutex);
    events_for_render.push_back(
        [this, arg]() { MouseMupEvent.exec(this, arg); });
}
...
void OpenGL::keyDown(int key) {
    ...
    std::lock_guard<std::mutex> lock(events_mutex);
    events_for_render.push_back(
        [this, arg]() { KeyDownEvent.exec(this, arg); });
}
